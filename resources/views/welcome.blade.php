...
<head>
    ...
    <title>Survey students FPT aptech</title>
    <!-- Fonts -->
    ...
    <style>
        body {
            ...
            background-image: url("https://sites.psu.edu/bjr5500/files/2017/07/background-wallpapers-beautiful-website-sphere-different-backgrounds-2hiuje6.jpg") no-repeat;
        }
    </style>
...
<body>
<div class="header bg-info p-3 pb-5">
    <div class="container">
        <h2 class="text-white">
